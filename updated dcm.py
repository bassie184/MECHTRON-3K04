...
class Ui_MainWindow(Ui_LoginWindow):
    ...
    def setupUiTWO(self, MainWindow):
        ...
        self.LogOut.setGeometry(QtCore.QRect(330, 50, 75, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setUnderline(True)
        font.setWeight(75)
        ...
        self.LogOut.clicked.connect(self.LogOutClicked)
        ...
        self.Load.clicked.connect(self.LoadClicked) #inputs variable data into text box
    ...
    def retranslateUiMainWindow(self, MainWindow):
        ...
        self.LoginOutput.setText(_translate("MainWindow", "No User Yet"))
    ...
    def LoadClicked(self):
        ...
        #save data from each input into user settings dictonary
